...
import { ArrowLeft, CircleAlert, ShieldCheck, Target } from "lucide-react";
      ...
      <div className="mx-auto flex h-14 w-full max-w-[1600px] items-center justify-between gap-3 px-4 sm:h-16 sm:px-8">
        ...
        <div className="flex min-w-0 items-center gap-2 lg:gap-3">
          {isAdmin ? (
            <Link
              href="/"
              className="inline-flex items-center gap-1.5 rounded-xl bg-sky-400 px-3.5 py-1.5 text-xs font-bold text-slate-950 shadow-[0_4px_16px_rgba(56,189,248,0.25)] transition hover:bg-sky-300 hover:scale-[1.02]"
            >
            ...
            <>
              ...
              <Link
                href="/admin"
                prefetch={false}
                className="ti-control inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-medium transition hover:text-white"
              >
